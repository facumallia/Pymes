...
myApp.controller("inicioCtrl", function ($scope) {
        $scope.Titulo = 'Pymes Demo';

    })

myApp.controller('ArticulosFamiliasCtrl',
    function ($scope, $http) {
        $scope.Titulo = 'Gestionar Articulos Familias';
...
myApp.controller('ArticulosCtrl',
    function ($scope, $http, myService) {
        ...
        $scope.Grabar = function () {
            ...
            {
                $http.post('/api/Articulos/', $scope.DtoSel).then(function (response) {
                ...
                $http.put('/api/Articulos/' + $scope.DtoSel.IdArticulo, $scope.DtoSel).then(function (response) {
                    $scope.Volver();
                    $scope.Buscar(); // vuelve a cargar los artículos desde el servidor
